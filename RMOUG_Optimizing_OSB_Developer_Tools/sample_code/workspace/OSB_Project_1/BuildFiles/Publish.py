...
def importToALSBDomain():
    try:
        ...
        print "preserveEnvValues=" + preserveEnvValues
        # For some reason this doesn't work when passing the var to the fn...
        if preserveEnvValues == true:
            alsbImportPlan.setPreserveExistingAccessControlPolicies(true)
            alsbImportPlan.setPreserveExistingCredentials(true)
            alsbImportPlan.setPreserveExistingEnvValues(true)
            alsbImportPlan.setPreserveExistingOperationalValues(true)
            alsbImportPlan.setPreserveExistingSecurityAndPolicyConfig(true)
        else:
...
try:
    ...
    passphrase = raw_input("Enter password:")
